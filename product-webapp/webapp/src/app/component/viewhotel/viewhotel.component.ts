  ...
  applyfilter()
  {
    ...
    if(this.star5checked)
    {
      ...
      for(let i=0;i<this.hotelArray.length;i++)
      {
        ...
        if(this.hotelArray[i].hotelCategory=="5starhotel")
        {
          this.filterHotel=[];
    ...
    if(this.star4checked)
    {
      for(let i=0;i<this.hotelArray.length;i++)
      {
        if(this.hotelArray[i].hotelCategory=="4starhotel")
        {
          if(this.filtered)
          {
            this.filterHotel.push(this.hotelArray[i]);
    ...
    if(this.star3checked)
    {
      for(let i=0;i<this.hotelArray.length;i++)
      {
        if(this.hotelArray[i].hotelCategory=="3starhotel")
        {
          if(this.filtered)
          {
            this.filterHotel.push(this.hotelArray[i]);
    ...
    if(this.star2checked)
    {
      for(let i=0;i<this.hotelArray.length;i++)
      {
        if(this.hotelArray[i].hotelCategory=="2starhotel")
        {
          if(this.filtered)
          {
            this.filterHotel.push(this.hotelArray[i]);
    ...
    if(this.star1checked)
    {
      for(let i=0;i<this.hotelArray.length;i++)
      {
        if(this.hotelArray[i].hotelCategory=="1starhotel")
        {
          if(this.filtered)
          {
            this.filterHotel.push(this.hotelArray[i]);
